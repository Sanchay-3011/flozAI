...
class OpenAIProvider(LLMClient):
    ...
    def _raw_chat(self, system_prompt: str, user_prompt: str, model: str = None, max_tokens: int = 800) -> str:
        ...
        if is_mock_key(self.api_key):
            return f"[Simulated Response from OpenAI {model or self._model}] System: {system_prompt} | User: {user_prompt}"
        ...
        if resp.status_code == 200:
            ...
            raise ValueError("Invalid OpenAI API key. Please check your key in AI Settings.")
